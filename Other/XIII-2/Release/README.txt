================================================================================
                    FF XIII-2 HD FONT & GUI MOD + SHADERS FIXES
================================================================================

Replaces the original Final Fantasy XIII-2 fonts, GUI elements, and map tiles
with high-resolution versions, resulting in sharper, cleaner visuals across
all menus, UI, and in-game maps.
Also fixes issues with multiple shaders, improves DoF, fixes shadows alpha calculation...
...
--------------------------------------------------------------------------------
  ...
  Copy the following into:
       <game_install_folder>/alba_data/prog/win/bin/

         - version.dll
         - hd_textures/         (entire folder)
         - hd_textures_shaders/ (entire folder)
